    ...
    def websocket_info(self) -> dict:
        ...
        response = {
            ...
            ATTR_TEMPERATURE: {
                ...
                ATTR_CURRENT: self.sensor_temperature.native_value or None,
            ...
            ATTR_ILLUMINANCE: {
                ...
                ATTR_CURRENT: (
                    ...
                    if self.sensor_illuminance.native_value not in (STATE_UNKNOWN, STATE_UNAVAILABLE, None)
                    else None
                ),
            ...
            ATTR_MOISTURE: {
                ...
                ATTR_CURRENT: self.sensor_moisture.native_value or None,
            ...
            ATTR_CONDUCTIVITY: {
                ...
                ATTR_CURRENT: self.sensor_conductivity.native_value or None,
            ...
            ATTR_HUMIDITY: {
                ...
                ATTR_CURRENT: self.sensor_humidity.native_value or None,
            ...
            ATTR_CO2: {
                ...
                ATTR_CURRENT: self.sensor_CO2.native_value or None,
            ...
            ATTR_DLI: {
                ...
                ATTR_CURRENT: self.dli.native_value if self.dli.native_value not in (STATE_UNKNOWN, STATE_UNAVAILABLE) else None,
            ...
            ATTR_WATER_CONSUMPTION: {
                ...
                ATTR_CURRENT: self.moisture_consumption.native_value or None,
            ...
            ATTR_FERTILIZER_CONSUMPTION: {
                ...
                ATTR_CURRENT: self.fertilizer_consumption.native_value or None,
            ...
            ATTR_POWER_CONSUMPTION: {
                ...
                ATTR_CURRENT: self.sensor_power_consumption.native_value or None,
            ...
            ATTR_PH: {
                ...
                ATTR_CURRENT: self.sensor_ph.native_value or None,
